; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29912.0 
	...
	TITLE	F:\STM32_proj\L4R9_proj\watch_demo\TouchGFX\build\Debug\obj\GeneratedFont.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__22FDAB8C_GeneratedFont@cpp DB 01H
msvcjmc	ENDS
...
; _this$ = ecx
; File F:\STM32_proj\L4R9_proj\watch_demo\TouchGFX\generated\fonts\include\fonts\GeneratedFont.hpp
; Line 28
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __172E2D76_GeneratedFont@hpp
...
; _this$ = ecx
; File F:\STM32_proj\L4R9_proj\watch_demo\TouchGFX\generated\fonts\src\GeneratedFont.cpp
; Line 24
	push	ebp
	mov	ebp, esp
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __22FDAB8C_GeneratedFont@cpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 25
