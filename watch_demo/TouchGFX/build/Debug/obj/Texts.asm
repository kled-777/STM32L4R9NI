; Listing generated by Microsoft (R) Optimizing Compiler Version 19.28.29912.0 
	...
	TITLE	F:\STM32_proj\L4R9_proj\watch_demo\TouchGFX\build\Debug\obj\Texts.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__7133CFEA_Texts@hpp DB 01H
__7FC35287_TypedText@hpp DB 01H
__5D31EAFF_MCUInstrumentation@hpp DB 01H
__86B5B0D3_ButtonController@hpp DB 01H
__7859E545_TouchController@hpp DB 01H
__1CB1A06F_Bitmap@hpp DB 01H
__2ED8AFF3_Event@hpp DB 01H
__8BA877BF_ClickEvent@hpp DB 01H
__38D15E5E_DragEvent@hpp DB 01H
__5AFC5770_GestureEvent@hpp DB 01H
__A2ACCCBF_Drawable@hpp DB 01H
...
__2A764C25_Atomic@hpp DB 01H
__36C68F85_DMA@hpp DB 01H
__404106F8_FrameBufferAllocator@hpp DB 01H
__A0DDC22E_UIEventListener@hpp DB 01H
__F4E2B13C_Gestures@hpp DB 01H
__92ED9D26_TextureMapTypes@hpp DB 01H
__91762ED7_DebugPrinter@hpp DB 01H
__F8372E45_LCD@hpp DB 01H
__7E34E13B_HAL@hpp DB 01H
__E1091EF0_Texts@cpp DB 01H
__40945160_TextProvider@hpp DB 01H
msvcjmc	ENDS
CONST	SEGMENT
...
PUBLIC	??_C@_1MO@HMDEHFNF@?$AAF?$AA?3?$AA?2?$AAS?$AAT?$AAM?$AA3?$AA2?$AA_?$AAp?$AAr?$AAo?$AAj?$AA?2?$AAL@ ; `string'
...
??_C@_1BC@PANDKMKI@?$AAu?$AAs?$AAe?$AAd?$AA?5?$AA?$DO?$AA?5?$AA1@ DB 'u', 00H
	...
	DB	00H, 00H, 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_1MO@HMDEHFNF@?$AAF?$AA?3?$AA?2?$AAS?$AAT?$AAM?$AA3?$AA2?$AA_?$AAp?$AAr?$AAo?$AAj?$AA?2?$AAL@
CONST	SEGMENT
??_C@_1MO@HMDEHFNF@?$AAF?$AA?3?$AA?2?$AAS?$AAT?$AAM?$AA3?$AA2?$AA_?$AAp?$AAr?$AAo?$AAj?$AA?2?$AAL@ DB 'F'
	DB	00H, ':', 00H, '\', 00H, 'S', 00H, 'T', 00H, 'M', 00H, '3', 00H
	DB	'2', 00H, '_', 00H, 'p', 00H, 'r', 00H, 'o', 00H, 'j', 00H, '\'
	DB	00H, 'L', 00H, '4', 00H, 'R', 00H, '9', 00H, '_', 00H, 'p', 00H
	DB	'r', 00H, 'o', 00H, 'j', 00H, '\', 00H, 'w', 00H, 'a', 00H, 't'
	DB	00H, 'c', 00H, 'h', 00H, '_', 00H, 'd', 00H, 'e', 00H, 'm', 00H
	DB	'o', 00H, '\', 00H, 'M', 00H, 'i', 00H, 'd', 00H, 'd', 00H, 'l'
...
; File F:\STM32_proj\L4R9_proj\watch_demo\TouchGFX\generated\texts\src\Texts.cpp
; Line 51
	push	ebp
	mov	ebp, esp
	...
	rep stosd
	mov	ecx, OFFSET __E1091EF0_Texts@cpp
...
; File F:\STM32_proj\L4R9_proj\watch_demo\Middlewares\ST\touchgfx\framework\include\touchgfx\TypedText.hpp
; Line 159
	push	ebp
	mov	ebp, esp
	...
	mov	eax, -858993460				; ccccccccH
	rep stosd
	mov	ecx, OFFSET __7FC35287_TypedText@hpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 160
...
; _this$ = ecx
; File F:\STM32_proj\L4R9_proj\watch_demo\Middlewares\ST\touchgfx\framework\include\touchgfx\TextProvider.hpp
; Line 268
	push	ebp
	mov	ebp, esp
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __40945160_TextProvider@hpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 269
	...
	mov	esi, esp
	push	269					; 0000010dH
	push	OFFSET ??_C@_1MO@HMDEHFNF@?$AAF?$AA?3?$AA?2?$AAS?$AAT?$AAM?$AA3?$AA2?$AA_?$AAp?$AAr?$AAo?$AAj?$AA?2?$AAL@
